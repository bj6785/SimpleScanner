package com.verifone.kail1.libyuv;
...
public class YuvUtil {
     ...
     * @param top        旋转角度
     **/
    public static native void cropYUV(byte[] src, int width, int height, byte[] dst, int dst_width, int dst_height, int left, int top, int rotation);
    ...
    public static native void yuvI420Scale(byte[] i420Src, int src_width, int src_height, byte[] i420Dst, int dst_width, int dst_height, int mode);
}

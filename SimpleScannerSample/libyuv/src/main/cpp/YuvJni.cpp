...
Java_com_verifone_kail1_libyuv_YuvUtil_compressYUV(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_verifone_kail1_libyuv_YuvUtil_cropYUV(JNIEnv *env, jclass type, jbyteArray src_, jint width,
                                     jint height, jbyteArray dst_, jint dst_width, jint dst_height,
                                     jint left, jint top, jint degree) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_verifone_kail1_libyuv_YuvUtil_yuvI420ToNV21(JNIEnv *env, jclass type, jbyteArray i420Src,
                                           jbyteArray nv21Src,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_verifone_kail1_libyuv_YuvUtil_yuvI420Scale(JNIEnv *env, jclass type,
                                                    jbyteArray i420src_, jint width,
                                                    jint height, jbyteArray i420dst_,
                                                    jint dst_width, jint dst_height,
                                                    jint mode) {
    jbyte *Src_data = env->GetByteArrayElements(i420src_, NULL);
    jbyte *Dst_data = env->GetByteArrayElements(i420dst_, NULL);
    //进行缩放的操作
    scaleI420(Src_data, width, height, Dst_data, dst_width, dst_height, mode);
    env->ReleaseByteArrayElements(i420dst_, Dst_data, 0);
}
